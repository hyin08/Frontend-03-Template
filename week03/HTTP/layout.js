function getStyle(element) {
    ...
    console.log("-----style-----", element.tagName);
...
function layout(element) {
    ...
    var step;
    //根据style.alignContent来计算crossBase和step
    ...
    flexLines.forEach(function(items) {
        ...
        for(var i = 0; i < items.length; i++) {
            ...
            if(align === 'stretch') {
                itemStyle[crossStart] = crossBase;
                itemStyle[crossEnd] = crossBase + crossSign * ((itemStyle[crossSize] !== null && itemStyle[crossSize] !== (void 0)) ? lineCrossSize : 0);
